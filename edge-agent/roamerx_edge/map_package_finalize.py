...
def finalize_map_package(
    ...
    *,
    ...
    manifest = {
        ...
        "origin_confirmed_heading_deg": gnss_origin.get("confirmed_heading_deg"),
        "origin_heading_offset_deg": gnss_origin.get("heading_offset_deg"),
        "origin_heading_confirmed_at_unix": gnss_origin.get("heading_confirmed_at_unix"),
        ...
        "loop_detection_duration_seconds": float(loop_result.get("detection_duration_seconds") or 0.0),
