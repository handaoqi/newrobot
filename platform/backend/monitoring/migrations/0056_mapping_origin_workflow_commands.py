...
class Migration(migrations.Migration):
    dependencies = [("monitoring", "0055_map_coordinate_mode")]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                choices=[
                    ...
                    ("sensor.restart", "重启传感器"), ("charge.start", "开始充电"),
                    ("charge.stop", "断开充电"), ("motion.start", "启动运控"),
                    ("motion.stop", "停止运控"), ("audio.volume", "调节扬声器音量"),
