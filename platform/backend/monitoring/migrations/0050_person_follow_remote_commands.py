...
REMOTE_COMMAND_CHOICES = [
    ...
    ("teleop.person_follow_start", "启动人员跟随"), ("teleop.person_follow_stop", "停止人员跟随"), ("teleop.person_follow_status", "查询人员跟随"),
]


class Migration(migrations.Migration):
    dependencies = [("monitoring", "0049_development_plan_mode")]

    operations = [
        migrations.AlterField(
            model_name="remotecommand",
            name="command_type",
            field=models.CharField(choices=REMOTE_COMMAND_CHOICES, max_length=32),
        ),
    ]
